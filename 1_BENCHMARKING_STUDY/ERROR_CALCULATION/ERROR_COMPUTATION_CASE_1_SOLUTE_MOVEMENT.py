...
series2 = DATAFRAME_CASE_1_DAY_1['CONC_RATIO_SIMULATED'].to_numpy().flatten()
...
print(f"SMAPE: {smape_DAY_1:.2f}%")
print(f"MAPE: {mape_DAY_1:.2f}%")
print('MAX_ABS_ERROR_DAY_1:', MAX_ABS_ERROR_DAY_1)
PLT.figure()
...
series2 = DATAFRAME_CASE_1_DAY_2['CONC_RATIO_SIMULATED'].to_numpy().flatten()
...
print('MAX_ABS_ERROR_DAY_2:', MAX_ABS_ERROR_DAY_2)
...
series2 = DATAFRAME_CASE_1_DAY_3['CONC_RATIO_SIMULATED'].to_numpy().flatten()
...
print('MAX_ABS_ERROR_DAY_3:', MAX_ABS_ERROR_DAY_3)
